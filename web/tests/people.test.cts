...
import type * as date_fns_module from "date-fns";
import type * as lodash_module from "lodash";
import type * as mockdate_module from "mockdate";

import type * as example_user_module from "./lib/example_user.cjs";
import type * as example_group_module from "./lib/example_group.cjs";
import type * as example_realm_module from "./lib/example_realm.cjs";
import type * as test_lib_module from "./lib/test.cjs";
import type * as i18n_module from "./lib/i18n.cjs";
import type * as namespace_module from "./lib/namespace.cjs";
import type * as zblueslip_module from "./lib/zblueslip.cjs";
import type * as zpage_params_module from "./lib/zpage_params.cjs";

import type * as message_user_ids_module from "../src/message_user_ids";
import type * as settings_data_module from "../src/settings_data";
import type * as channel_module from "../src/channel";
import type * as muted_users_module from "../src/muted_users";
import type * as people_module from "../src/people";
import type * as settings_config_module from "../src/settings_config";
import type * as state_data_module from "../src/state_data";
import type * as user_groups_module from "../src/user_groups";
import type * as user_settings_module from "../src/user_settings";
import type * as util_module from "../src/util";

const assert: typeof assert_module = require("node:assert/strict") as typeof assert_module;

const {parseISO}: typeof date_fns_module = require("date-fns") as typeof date_fns_module;
const _: typeof lodash_module = require("lodash") as typeof lodash_module;
const MockDate: typeof mockdate_module = require("mockdate") as typeof mockdate_module;

const {make_user_group}: typeof example_group_module = require("./lib/example_group.cjs") as typeof example_group_module;
const {make_realm}: typeof example_realm_module = require("./lib/example_realm.cjs") as typeof example_realm_module;
const {make_bot, make_cross_realm_bot, make_user, Role}: typeof example_user_module = require("./lib/example_user.cjs") as typeof example_user_module;
const {run_test, noop}: typeof test_lib_module = require("./lib/test.cjs") as typeof test_lib_module;
const {$t}: typeof i18n_module = require("./lib/i18n.cjs") as typeof i18n_module;
const {mock_esm, zrequire, set_global}: typeof namespace_module = require("./lib/namespace.cjs") as typeof namespace_module;
const blueslip: typeof zblueslip_module = require("./lib/zblueslip.cjs") as typeof zblueslip_module;
const {page_params}: typeof zpage_params_module = require("./lib/zpage_params.cjs") as typeof zpage_params_module;

const message_user_ids: typeof message_user_ids_module = mock_esm("../src/message_user_ids");
const settings_data: typeof settings_data_module = mock_esm("../src/settings_data", {
    user_can_access_all_other_users: () => true,
});
const channel: typeof channel_module = mock_esm("../src/channel");

let additional_calls_before_set_timeout: () => void = noop;

set_global("setTimeout", (func: () => void) => {
    additional_calls_before_set_timeout();
    func();
});

const muted_users: typeof muted_users_module = zrequire("muted_users");
const people: typeof people_module = zrequire("people");
const settings_config: typeof settings_config_module = zrequire("../src/settings_config.ts");
const {set_current_user, set_realm}: typeof state_data_module = zrequire("state_data");
const user_groups: typeof user_groups_module = zrequire("user_groups");
const {initialize_user_settings}: typeof user_settings_module = zrequire("user_settings");
const util: typeof util_module = zrequire("util");

const current_user = {} as any;
set_current_user(current_user);
const realm = make_realm() as any;
set_realm(realm);
const user_settings = {} as any;
